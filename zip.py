...
def main():
    ...
    common_apps={'ssl':'443','web-browsing':'80','dns':'53','ftp':'21','ssh':'22','netbios-ss':'139',
                 'snmp':'161','ms-rdp':'3389','socks':'1080','ntp':'123','tacacs':'49', 'telnet':'23', 'portmapper':'111', 'nfs':'2049', 'mysql':'3306',  'wins':'42'
                 ,'rdp2tcp':'3389','lotus-notes-base':'1352','smtp':'25'}
    common_apps_list={'ldap':['389','3268','3269','636'],'db2':['50000','60000'],'ms-ds-smb':['139','445'],'kerberos':['88','464', '749', '750', '754'],'ms-netlogon':['1025-5000', '49152-65535', '137', '138'],'WinRM':['5985','5986'],
    ...
    def app_name(ss):
        ...
        sheet = load_spreadsheet['Sheet1']  # Get a sheet from the workbook
        app_values=[]
        for row in sheet.iter_cols(min_col=9, min_row=2, max_col=9,
                                       max_row=100):  # iterate through all rows in specific column
